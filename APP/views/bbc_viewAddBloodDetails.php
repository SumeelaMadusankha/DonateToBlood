                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form role="form" method="POST" action="../BB_Coordinater/add_BloodDetails"  id="shortage_form">
                                        <div class="form-group">
                                                <label>Blood Group</label>
                                                <select class="form-control" name="add_b_type" id="add_b_type">
                                                <option>O-</option>
                                                <option>O+</option>
                                                <option>B-</option>
                                                <option>B+</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" placeholder="Maximum Quantity for given Blood Type" name="m_quantity" id="m_quantity">
                                            </div>
                                            <div class="form-group">
                                                <label>Available Quantity</label>
                                                <input class="form-control" type="text" placeholder="Available Quantity for given Blood Type" name="a_quantity" id="a_quantity">
                                            </div>
                                            
                                            <input type="submit" value="Add Blood Data" class="btn btn-default" name="add_blood_btn" >
                                        </form>
                                    </div>
                                </div>
                                <!-- /.row (nested) -->
